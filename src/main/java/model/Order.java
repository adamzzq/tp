...
public class Order implements ItemManager {
    ...
    private static final int CASHIER_OFFSET = 14;
    ...
    public String getReceipt(double discount)  {
        ...
        receiptBuilder.append(ROW_DELIMITER)
                ...
                .append("Order Type: ")
                .append(orderType)
                .append(" ".repeat(ROW_DELIMITER.length() - orderType.length() - CASHIER_OFFSET))
                .append("|\n")
        ...
        receiptBuilder.append("Cashier: ")
                .append(userName)
                .append(" ".repeat(ROW_DELIMITER.length() - userName.length()-11))
                .append("|\n")
                .append(ROW_DELIMITER);
