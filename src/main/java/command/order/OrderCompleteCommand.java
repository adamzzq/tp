...
public class OrderCompleteCommand implements OrderCommand {
    ...
    public static boolean execute(Order order, Scanner input) {
        ...
        System.out.println("WARNING: Once an order is completed, you are NOT ALLOWED to edit or delete them.");
        System.out.println("Do you want to complete the order? (y/n)");
