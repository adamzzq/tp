...
public class MenuHelpCommand implements MenuCommand {
    ...
    public static void execute() {
        ...
        System.out.println("\tadd -item <item_name> -price <price_of_item> : " +
                            "Adds a new item to the menu.");
        System.out.println("\tdelete -item <item_id> : Deletes an item from the menu.");
        System.out.println("\tview items: Shows all the items in the current menu.");
        System.out.println("\tcomplete: Completes the menu and returns to the main menu.");
        System.out.println("\tcancel: Aborts the current menu and returns to the main menu.");
    }
}
